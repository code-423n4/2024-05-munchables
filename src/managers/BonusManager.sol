...
contract BonusManager is IBonusManager, BaseConfigStorage, BaseBlastManager {
        ...
        if (didMigrate) {
            ...
            if (weightedValue >= migrateHighestAmount) {
                ...
                _migrationBonus =
                    ...
                    (migrateHighestAmount - weightedValue);
            }
        }
    }
